        ...
        <div class="container">
            ...
            <article class="content--main" role="main">
                <div class="typography" style="width: 40em; margin: 0 auto;">
                    ...
                    <h1>Style Guide and Elements included with this Scaffold</h1>
                    
                    <p>Below are all the likely HTML elements an author will use, and the way we prefer them minimally styled. <!--Included as a bonus are some markup patterns for other design elements, like triangles (pointers).--> </p>
...
.example + .examplecode { margin-top: -1.5em; }
.element-caption { display: block; }

.sample-triangle, .sample-outline-triangle {
    position: relative; 
...
.sample-outline-triangle {
    color: #666; 
    border: 1px solid #e2277e; 
}
</style>
             
                
<h1 id="menu">Style Guide and Sample Code</h1>
<p><strong>These are basic markup and typographic styles for your site and how to use them.</strong> Most of these options are availabel through the TinyMCE edit window in the admin, but some will require knowledge of coding HTML. </p>
...
<!--<h3>Triangles and Arrows</h3>
<p>New mixin for creating triangles, <code>@include pe-triangle()</code>. Here are some examples.</p>
<div class="example">
    <div class="sample-triangle triangle-top">Triangle up</div>
    <div class="sample-triangle triangle-left">Triangle left</div>
    <div class="sample-triangle triangle-right">Triangle right</div>
    <div class="sample-triangle triangle-bottom">Triangle down</div>
</div>
<pre class="examplecode"><code>&lt;div class="sample-triangle triangle-top"&gt;Triangle up&lt;/div&gt;</code></pre>

<p>New mixin for creating a triangle with an outline, <code>@include pe-outline-triangle()</code>. Here are some examples.</p>
<div class="example">
    <div class="sample-outline-triangle triangle-outline-top">Outlined triangle up</div>
    <div class="sample-outline-triangle triangle-outline-left">Outlined triangle left</div>
    <div class="sample-outline-triangle triangle-outline-right">Outlined triangle right</div>
    <div class="sample-outline-triangle triangle-outline-bottom">Outlined triangle down</div>
</div>
<pre class="examplecode"><code>&lt;div class="sample-outline-triangle triangle-outline-top"&gt;Outline triangle up&lt;/div&gt;</code></pre>-->
...
<p>There are all the styles that can be present inside the main content area with class <code>.text</code>. Hope this helps you craft beautiful <strong>and semantic</strong> content</p>
